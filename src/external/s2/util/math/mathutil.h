...
class MathUtil {
 public:
  ...
  //
  //   Numbers that are halfway between two integers follow the default
...
#if defined __GNUC__ && (defined __i386__ || defined __SSE2__) && !(BARQ_WATCHOS && !BARQ_APPLE_DEVICE)
#if defined __SSE2__
    // SSE2.
    int32 result;
...
#else
    return static_cast<int32>(std::rint(x));
#endif  // if defined __GNUC__ && ...
  }

  static int64 FastInt64Round(double x) {
#if defined __GNUC__ && (defined __i386__ || defined __x86_64__) && !(BARQ_WATCHOS && !BARQ_APPLE_DEVICE)
...
#else
    return static_cast<int64>(std::llrint(x));
#endif  // if defined __GNUC__ && ...
  }
