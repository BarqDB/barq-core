...
#ifndef BARQ_ARRAY_FIXED_BYTES_HPP
#define BARQ_ARRAY_FIXED_BYTES_HPP
...
public:
    ...
    {
        BARQ_ASSERT(is_valid_ndx(ndx));
        BARQ_ASSERT(!is_null(ndx));
...
#endif /* BARQ_ARRAY_FIXED_BYTES_HPP */
