...
#ifndef BARQ_AGGREGATE_OPS_HPP
#define BARQ_AGGREGATE_OPS_HPP
...
namespace barq::aggregate_operations {
...
class Sum {
public:
    using ResultType = typename barq::ColumnSumType<T>;
...
class Average {
public:
    using ResultType = typename std::conditional<barq::is_any_v<T, Decimal128, Mixed>, Decimal128, double>::type;
    ...
    ResultType result() const
    {
        BARQ_ASSERT_EX(m_count > 0, m_count);
