...
#ifndef BARQ_UTIL_INTERPROCESS_MUTEX
#define BARQ_UTIL_INTERPROCESS_MUTEX
...
#if BARQ_PLATFORM_APPLE || BARQ_ANDROID
#define BARQ_ROBUST_MUTEX_EMULATION 1
#else
#define BARQ_ROBUST_MUTEX_EMULATION 0
#endif
...
#if BARQ_ROBUST_MUTEX_EMULATION || defined(_WIN32)
    struct SharedPart {};
#else
...
#if BARQ_ROBUST_MUTEX_EMULATION
                                               ...
                                               const std::string& mutex_name)
{
    ...
    std::string name = "Local\\barq_named_intermutex_" + path_escaped + mutex_name;
...
inline void InterprocessMutex::lock()
{
    ...
    BARQ_ASSERT_RELEASE(d != WAIT_FAILED);
#else
...
#endif // #ifndef BARQ_UTIL_INTERPROCESS_MUTEX
