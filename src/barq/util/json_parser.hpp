#ifndef BARQ_UTIL_JSON_PARSER_HPP
#define BARQ_UTIL_JSON_PARSER_HPP
...
namespace std {
template <>
struct is_error_condition_enum<barq::util::JSONParser::Error> {
...
{
    BARQ_ASSERT(type == EventType::string);
    BARQ_ASSERT(range.size() >= 2);
...
#endif // BARQ_UTIL_JSON_PARSER_HPP
