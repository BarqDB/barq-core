...
#ifndef BARQ_UTIL_BASIC_SYSTEM_ERRORS_HPP
#define BARQ_UTIL_BASIC_SYSTEM_ERRORS_HPP

#include <cerrno>
#include <system_error>

namespace barq::util::error {
...
template <>
class is_error_code_enum<barq::util::error::basic_system_errors> {
public:
...
#endif // BARQ_UTIL_BASIC_SYSTEM_ERRORS_HPP
