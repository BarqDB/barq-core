...
#ifndef BARQ_UTIL_LOGGER_HPP
#define BARQ_UTIL_LOGGER_HPP
...
public:
    ...
    ///             output.
    // equivalent to barq_log_level_e in barq.h and must be kept in sync -
...
private:
    template <class... Params>
    BARQ_NOINLINE void do_log(const LogCategory& category, Level, const char* message, Params&&...);
};
