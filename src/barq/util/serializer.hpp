...
#ifndef BARQ_UTIL_SERIALIZER_HPP
#define BARQ_UTIL_SERIALIZER_HPP
...
template <>
std::string print_value<>(barq::null);
template <>
std::string print_value<>(StringData);
template <>
std::string print_value<>(barq::Timestamp);
template <>
std::string print_value<>(barq::ObjectId);
template <>
std::string print_value<>(barq::ObjKey);

std::string print_value(barq::ObjLink, Group*);

template <>
std::string print_value<>(barq::UUID);
template <>
std::string print_value<>(barq::TypeOfValue);

#if BARQ_ENABLE_GEOSPATIAL
template <>
std::string print_value<>(const barq::Geospatial&);
#endif // BARQ_ENABLE_GEOSPATIAL
...
#endif // BARQ_UTIL_SERIALIZER_HPP
