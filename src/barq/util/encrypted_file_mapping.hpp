...
#ifndef BARQ_UTIL_ENCRYPTED_FILE_MAPPING_HPP
#define BARQ_UTIL_ENCRYPTED_FILE_MAPPING_HPP
...
private:
    ...
    BARQ_NORETURN void throw_decryption_error(size_t ndx, std::string_view msg) REQUIRES(m_file.mutex);
...
#endif // BARQ_UTIL_ENCRYPTED_FILE_MAPPING_HPP
