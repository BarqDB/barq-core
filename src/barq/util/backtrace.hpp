...
#ifndef BARQ_UTIL_BACKTRACE_HPP
#define BARQ_UTIL_BACKTRACE_HPP
...
inline std::ostream& operator<<(std::ostream& os, const barq::util::Backtrace& bt)
{
    bt.print(os);
    return os;
}

#endif // BARQ_UTIL_BACKTRACE_HPP
