...
#ifndef BARQ_UTIL_SCRATCH_ALLOCATOR_HPP
#define BARQ_UTIL_SCRATCH_ALLOCATOR_HPP
...
{
    BARQ_ASSERT(m_current_arena == nullptr);
}
...
{
    BARQ_ASSERT(&current_arena == m_current_arena);
    BARQ_ASSERT(checkpoint <= m_position);
...
#endif // BARQ_UTIL_SCRATCH_ALLOCATOR_HPP
