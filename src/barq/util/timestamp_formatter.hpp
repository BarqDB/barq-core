...
#ifndef BARQ_UTIL_TIMESTAMP_FORMATTER_HPP
#define BARQ_UTIL_TIMESTAMP_FORMATTER_HPP
...
inline auto TimestampFormatter::format(std::chrono::time_point<B> time) -> string_view_type
{
    ...
    BARQ_ASSERT(nanoseconds >= 0 && nanoseconds < 1000000000);
...
#endif // BARQ_UTIL_TIMESTAMP_FORMATTER_HPP
