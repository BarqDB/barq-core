...
#ifndef BARQ_UTIL_FILE_HPP
#define BARQ_UTIL_FILE_HPP
...
#include <filesystem>
#define BARQ_HAVE_STD_FILESYSTEM 1
#else
#define BARQ_HAVE_STD_FILESYSTEM 0
#endif

#if BARQ_APPLE_DEVICE && !BARQ_TVOS && !BARQ_MACCATALYST
#define BARQ_FILELOCK_EMULATION
#endif
