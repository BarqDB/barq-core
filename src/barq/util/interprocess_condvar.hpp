...
#ifndef BARQ_UTIL_INTERPROCESS_CONDVAR
#define BARQ_UTIL_INTERPROCESS_CONDVAR
...
/// for the inter-process case, if enabled by BARQ_CONDVAR_EMULATION.
///
...
private:
    ...
    struct HandleHolder {
        ...
        {
            if (handle)
                BARQ_ASSERT_RELEASE(CloseHandle(handle));
        }
