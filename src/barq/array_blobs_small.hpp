...
#ifndef BARQ_ARRAY_BLOBS_SMALL_HPP
#define BARQ_ARRAY_BLOBS_SMALL_HPP
...
{
    BARQ_ASSERT_3(ndx, <, m_offsets.size());
...
{
    BARQ_ASSERT_3(ndx, <, m_nulls.size());
...
{
    BARQ_ASSERT(new_size == 0 || new_size < m_offsets.size());
