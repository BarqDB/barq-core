...
#ifndef BARQ_COLLECTION_NOTIFICATIONS_HPP
#define BARQ_COLLECTION_NOTIFICATIONS_HPP

#include <barq/path.hpp>
#include <barq/object-store/index_set.hpp>
#include <barq/object-store/util/atomic_shared_ptr.hpp>
...
#endif // BARQ_COLLECTION_NOTIFICATIONS_HPP
