...
#ifndef BARQ_OS_DICTIONARY_HPP
#define BARQ_OS_DICTIONARY_HPP
...
public:
    using Iterator = barq::Dictionary::Iterator;
    ...
    Dictionary freeze(const std::shared_ptr<Barq>& barq) const;
...
private:
    ...
    barq::Dictionary& dict() const noexcept
    {
        BARQ_ASSERT_DEBUG(dynamic_cast<barq::Dictionary*>(m_coll_base.get()));
        return static_cast<barq::Dictionary&>(*m_coll_base);
    }
