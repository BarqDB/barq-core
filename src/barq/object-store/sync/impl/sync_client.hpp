...
#ifndef BARQ_OS_SYNC_CLIENT_HPP
#define BARQ_OS_SYNC_CLIENT_HPP
...
#include <barq/object-store/sync/impl/network_reachability.hpp>

#if NETWORK_REACHABILITY_AVAILABLE
#include <barq/object-store/sync/impl/apple/network_reachability_observer.hpp>
#endif

#ifdef __EMSCRIPTEN__
#include <barq/object-store/sync/impl/emscripten/socket_provider.hpp>
#endif
...
#else
            auto user_agent = util::format("BarqSync/%1 (%2) %3 %4", BARQ_VERSION_STRING, util::get_platform_info(),
