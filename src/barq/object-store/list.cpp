...
{
    verify_attached();
    return Results(m_barq, std::dynamic_pointer_cast<LnkLst>(m_coll_base), get_query().and_query(std::move(q)));
}
...
List List::freeze(std::shared_ptr<Barq> const& frozen_barq) const
{
    auto frozen_list(frozen_barq->import_copy_of(*m_coll_base));
    if (frozen_list) {
        return List(frozen_barq, std::move(frozen_list));
    }
    else {
        return List{};
    }
...
#define BARQ_PRIMITIVE_LIST_TYPE(T)                                                                                 \
...
BARQ_PRIMITIVE_LIST_TYPE(bool)
BARQ_PRIMITIVE_LIST_TYPE(int64_t)
BARQ_PRIMITIVE_LIST_TYPE(float)
BARQ_PRIMITIVE_LIST_TYPE(double)
BARQ_PRIMITIVE_LIST_TYPE(StringData)
BARQ_PRIMITIVE_LIST_TYPE(BinaryData)
BARQ_PRIMITIVE_LIST_TYPE(Timestamp)
BARQ_PRIMITIVE_LIST_TYPE(ObjKey)
BARQ_PRIMITIVE_LIST_TYPE(ObjectId)
BARQ_PRIMITIVE_LIST_TYPE(Decimal)
BARQ_PRIMITIVE_LIST_TYPE(UUID)
BARQ_PRIMITIVE_LIST_TYPE(util::Optional<bool>)
BARQ_PRIMITIVE_LIST_TYPE(util::Optional<int64_t>)
BARQ_PRIMITIVE_LIST_TYPE(util::Optional<float>)
BARQ_PRIMITIVE_LIST_TYPE(util::Optional<double>)
BARQ_PRIMITIVE_LIST_TYPE(util::Optional<ObjectId>)
BARQ_PRIMITIVE_LIST_TYPE(util::Optional<UUID>)
...
#undef BARQ_PRIMITIVE_LIST_TYPE
} // namespace barq
