...
#ifndef BARQ_OBJECT_SCHEMA_HPP
#define BARQ_OBJECT_SCHEMA_HPP
...
public:
    ...
    /// Note: Enumeration value assignments must be kept in sync with <barq/table.hpp>.
...
#endif /* defined(BARQ_OBJECT_SCHEMA_HPP) */
