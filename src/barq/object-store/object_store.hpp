...
#ifndef BARQ_OBJECT_STORE_HPP
#define BARQ_OBJECT_STORE_HPP
...
class ObjectStore {
public:
    // Schema version used for uninitialized Barqs
    ...
    // updates a Barq from old_schema to the given target schema, creating and updating tables as needed
    ...
    static barq::TableRef table_for_object_type(Group& group, StringData object_type);
    static barq::ConstTableRef table_for_object_type(Group const& group, StringData object_type);
...
#endif /* defined(BARQ_OBJECT_STORE_HPP) */
