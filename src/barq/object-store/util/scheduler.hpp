...
#ifndef BARQ_OS_UTIL_SCHEDULER
#define BARQ_OS_UTIL_SCHEDULER
...
#if (defined(BARQ_HAVE_UV) && BARQ_HAVE_UV && !BARQ_PLATFORM_APPLE) ||                                            \
    (defined(BARQ_PLATFORM_NODE) && BARQ_PLATFORM_NODE)
#define BARQ_USE_UV 1
#else
#define BARQ_USE_UV 0
#endif

#if !defined(BARQ_USE_CF) && BARQ_PLATFORM_APPLE
#define BARQ_USE_CF 1
#elif !defined(BARQ_USE_ALOOPER) && BARQ_ANDROID
#define BARQ_USE_ALOOPER 1
#endif
...
public:
    ...
    ///
    /// In builds where `BARQ_USE_UV=1` (such as Node.js builds), regardless of
    ...
    /// Create a scheduler for frozen Barqs. This scheduler does not support
    ...
    /// functionality. This should be used only for Barqs opened internally
