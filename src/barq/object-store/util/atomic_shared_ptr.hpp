...
#ifndef BARQ_ATOMIC_SHARED_PTR_HPP
#define BARQ_ATOMIC_SHARED_PTR_HPP
...
template <typename T, bool = barq::_impl::HasAtomicPtrOps<std::shared_ptr<T>>::value>
...
#endif // BARQ_ATOMIC_SHARED_PTR_HPP
