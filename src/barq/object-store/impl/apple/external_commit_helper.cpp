...
// named pipe in the filesystem next to the Barq file. Everyone who wants to be
...
// When a BARQBarq instance is created, we add a CFRunLoopSource to the current
...
// which in our case just invokes `[barq handleExternalChange]`.
...
{
    pthread_setname_np("Barq notification listener");
