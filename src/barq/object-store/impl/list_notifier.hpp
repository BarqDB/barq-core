...
#ifndef BARQ_LIST_NOTIFIER_HPP
#define BARQ_LIST_NOTIFIER_HPP
...
public:
    ListNotifier(std::shared_ptr<Barq> barq, CollectionBase const& list, PropertyType type);
