...
#ifndef BARQ_ARRAY_BASIC_HPP
#define BARQ_ARRAY_BASIC_HPP
...
public:
    ...
    bool is_null(size_t ndx) const noexcept
    {
        ...
        static_assert(barq::is_any<T, float, double>::value, "T can only be float or double");
...
#include <barq/array_basic_tpl.hpp>

#endif // BARQ_ARRAY_BASIC_HPP
