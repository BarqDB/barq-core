...
#ifndef BARQ_ARRAY_MIXED_HPP
#define BARQ_ARRAY_MIXED_HPP
...
public:
    ...
    size_t find_first(Mixed value, size_t begin = 0, size_t end = barq::npos) const noexcept;
    bool ensure_keys();
