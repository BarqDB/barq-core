...
#ifndef BARQ_ARRAY_DECIMAL128_HPP
#define BARQ_ARRAY_DECIMAL128_HPP
...
public:
    ...
    {
        return nullable ? Decimal128(barq::null()) : Decimal128(0);
    }
    ...
    {
        BARQ_ASSERT(ndx < m_size);
        switch (m_width) {
            case 0:
                return get_context_flag() ? Decimal128() : Decimal128(barq::null());
            case 4: {
...
#endif /* BARQ_ARRAY_DECIMAL128_HPP */
