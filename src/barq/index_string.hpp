...
#ifndef BARQ_INDEX_STRING_HPP
#define BARQ_INDEX_STRING_HPP
...
// 16 is the biggest element size of any non-string/binary Barq type
...
public:
    ...
    static bool type_supported(barq::DataType type)
    {
...
{
    BARQ_ASSERT_EX(Array::get_context_flag_from_header(alloc.translate(ref)), ref, size_t(alloc.translate(ref)));
