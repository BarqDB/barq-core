...
std::string make_sec_websocket_accept(StringData sec_websocket_key)
{
    ...
    BARQ_ASSERT(base64_output_size == 28);
...
private:
    ...
    void handle_http_request_received(HTTPRequest request)
    {
        ...
        util::Optional<HTTPResponse> response =
            do_make_http_response(request, sec_websocket_protocol ? *sec_websocket_protocol : "barq.io", ec);
...
public:
    ...
    {
        return "barq::sync::websocket::HttpError";
    }
