...
#ifndef BARQ_OS_BINDING_CALLBACK_THREAD_OBSERVER_HPP
#define BARQ_OS_BINDING_CALLBACK_THREAD_OBSERVER_HPP
...
#endif // BARQ_OS_BINDING_CALLBACK_THREAD_OBSERVER_HPP
