...
#ifndef BARQ_SYNC_CHANGESET_ENCODER_HPP
#define BARQ_SYNC_CHANGESET_ENCODER_HPP
...
#define BARQ_DEFINE_INSTRUCTION_HANDLER(X) void operator()(const Instruction::X&);
    BARQ_FOR_EACH_INSTRUCTION_TYPE(BARQ_DEFINE_INSTRUCTION_HANDLER)
#undef BARQ_DEFINE_INSTRUCTION_HANDLER
...
#endif // BARQ_SYNC_CHANGESET_ENCODER_HPP
