...
struct WebSocketInterface {
    ...
    /// For implementations that support it, return the Barq request ID header
    /// value, i.e. the "X-Barq-Request-Id" header value.
    ///
    ...
    virtual std::string_view get_barq_request_id() const noexcept
    {
        return {};
    }
