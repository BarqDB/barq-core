...
#ifndef BARQ_SYNC_OBJECT_ID_HPP
#define BARQ_SYNC_OBJECT_ID_HPP
...
// Any unambiguous object identifier. Monostate represents NULL (can't use barq::None or std::nullptr_t because they
