...
#ifndef BARQ_SYNC_SUBSCRIPTIONS_HPP
#define BARQ_SYNC_SUBSCRIPTIONS_HPP
...
public:
    ...
    // copy the data for the subscription over from the fresh Barq.
...
#endif // BARQ_SYNC_SUBSCRIPTIONS_HPP
