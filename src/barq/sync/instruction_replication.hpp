...
#ifndef BARQ_SYNC_IMPL_INSTRUCTION_REPLICATION_HPP
#define BARQ_SYNC_IMPL_INSTRUCTION_REPLICATION_HPP
...
public:
    ...
    /// Barq anyway. The purpose of this instruction is to allow observers
...
private:
    ...
    BARQ_NORETURN void unsupported_instruction() const; // Throws TransformError
...
#endif // BARQ_SYNC_IMPL_INSTRUCTION_REPLICATION_HPP
