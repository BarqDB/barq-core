...
struct AccessControl {
    ...
    /// Barq file using the particular access token.
    ///
    ...
    ///
    /// NOTE: This method is thread-safe.
    bool can(const AccessToken&, Privilege, const BarqFileIdent&) const noexcept;
    bool can(const AccessToken&, unsigned int mask, const BarqFileIdent&) const noexcept;
    //@}
...
#endif // BARQ_SYNC_ACCESS_CONTROL_HPP
