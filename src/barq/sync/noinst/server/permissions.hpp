...
#ifndef BARQ_SYNC_PERMISSIONS_HPP
#define BARQ_SYNC_PERMISSIONS_HPP
...
enum class Privilege : uint_least32_t {
    ...
    /// When applied as a "Barq" privilege, the user can add classes and add
    /// columns to classes.
    ///
    ...
    DeleteBarq = Upload, // FIXME: This seems overly permissive
};
...
#endif // BARQ_SYNC_PERMISSIONS_HPP
