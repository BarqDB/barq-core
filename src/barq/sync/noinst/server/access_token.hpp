#ifndef BARQ_SYNC_ACCESS_TOKEN_HPP
#define BARQ_SYNC_ACCESS_TOKEN_HPP
...
using BarqFileIdent = std::string; // path
...
struct AccessToken {
    ...
    util::Optional<BarqFileIdent> path;
...
#endif // BARQ_SYNC_ACCESS_TOKEN_HPP
