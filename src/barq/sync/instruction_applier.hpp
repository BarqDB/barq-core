...
#ifndef BARQ_SYNC_IMPL_INSTRUCTION_APPLIER_HPP
#define BARQ_SYNC_IMPL_INSTRUCTION_APPLIER_HPP
...
#define BARQ_DECLARE_INSTRUCTION_HANDLER(X) virtual void operator()(const Instruction::X&);
...
private:
    ...
    BARQ_NORETURN void bad_transaction_log(const std::string& msg) const;
    template <class... Params>
    BARQ_NORETURN void bad_transaction_log(const char* msg, Params&&... params) const;
};
...
#endif // BARQ_SYNC_IMPL_INSTRUCTION_APPLIER_HPP
