...
#ifndef BARQ_CLUSTER_HPP
#define BARQ_CLUSTER_HPP
...
public:
    ...
    struct State {
        ...
        size_t index = barq::npos; // The index within the Cluster at which the object is stored.

        operator bool() const
        {
            return index != barq::npos;
        }
    };
