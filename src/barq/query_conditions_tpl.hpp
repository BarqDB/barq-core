...
#ifndef BARQ_QUERY_CONDITIONS_TPL_HPP
#define BARQ_QUERY_CONDITIONS_TPL_HPP
...
public:
    ...
    {
        if (m_source_column) {
            BARQ_ASSERT_DEBUG(value.is_null());
...
#endif /* BARQ_QUERY_CONDITIONS_TPL_HPP */
