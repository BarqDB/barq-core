...
#ifndef BARQ_PARSER_QUERY_PARSER_HPP
#define BARQ_PARSER_QUERY_PARSER_HPP
...
struct AnyContext {
    ...
    bool is_null(const std::any& wrapper)
    {
        ...
        if (wrapper.type() == typeid(barq::null)) {
            return true;
        }
        return false;
    }
...
#endif /* BARQ_PARSER_QUERY_PARSER_HPP */
