...
static_assert(sizeof(barq::UUID::UUIDBytes) == 16, "A change to the size of UUID is a file format breaking change");
static_assert(barq::UUID::num_bytes == 16, "A change to the size of UUID is a file format breaking change");
static_assert(sizeof(null_uuid_string) - 1 == (sizeof(barq::UUID::UUIDBytes) * 2) + 4,
