...
#ifndef BARQ_DECIMAL_HPP
#define BARQ_DECIMAL_HPP
...
namespace std {
template <>
struct numeric_limits<barq::Decimal128> {
    static constexpr bool is_integer = false;
    static barq::Decimal128 lowest() noexcept
    {
        return barq::Decimal128("-Inf");
    }
    static barq::Decimal128 max() noexcept
    {
        return barq::Decimal128("+Inf");
    }
};
