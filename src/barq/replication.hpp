...
#ifndef BARQ_REPLICATION_HPP
#define BARQ_REPLICATION_HPP
...
public:
    ...
    enum HistoryType {
        ...
        /// synchronization protocol (barq::sync::ClientHistory).
        hist_SyncClient = 3,

        /// In-Barq history supporting continuous transactions and server-side
        /// synchronization protocol (barq::_impl::ServerHistory).
        hist_SyncServer = 4
    };
