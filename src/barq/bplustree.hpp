...
#ifndef BARQ_BPLUSTREE_HPP
#define BARQ_BPLUSTREE_HPP
...
public:
    ...
    public:
        ...
        void bp_set_parent(barq::ArrayParent* p, size_t n) override
        {
    ...
    BARQ_NOINLINE T get_uncached(size_t n) const
    {
        T value;
    ...
    {
        while (m_root->get_node_size() > BARQ_MAX_BPNODE_SIZE) {
            split_root();
        }
    }
