...
#ifndef BARQ_IMPL_INPUT_STREAM_HPP
#define BARQ_IMPL_INPUT_STREAM_HPP

#include <barq/util/input_stream.hpp>

#include <barq/column_binary.hpp>
...
public:
    ...
    util::Span<const char> next_block() override
    {
        while (m_valid) {
            ...
            if (BARQ_UNLIKELY(m_changesets_begin == m_changesets_end)) {
                get_changeset();
            }
        }
...
#endif // BARQ_IMPL_INPUT_STREAM_HPP
