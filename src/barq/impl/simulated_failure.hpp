...
#ifndef BARQ_IMPL_SIMULATED_FAILURE_HPP
#define BARQ_IMPL_SIMULATED_FAILURE_HPP
...
#ifdef BARQ_DEBUG
#define BARQ_ENABLE_SIMULATED_FAILURE
#endif
...
public:
    ...
    /// type on the calling thread, but only if BARQ_ENABLE_SIMULATED_FAILURE
    /// was defined during compilation. If BARQ_ENABLE_SIMULATED_FAILURE was
    ...
    /// Returns true when, and only when BARQ_ENABLE_SIMULATED_FAILURE was
...
private:
#ifdef BARQ_ENABLE_SIMULATED_FAILURE
...
template <>
struct is_error_code_enum<barq::_impl::SimulatedFailure::FailureType> {
...
#endif // BARQ_IMPL_SIMULATED_FAILURE_HPP
