...
#ifndef BARQ_UTILITIES_HPP
#define BARQ_UTILITIES_HPP
...
#define BARQ_X86_OR_X64
#define BARQ_X86_OR_X64_TRUE true
#else
#define BARQ_X86_OR_X64_TRUE false
#endif

// GCC defines __arm__
#ifdef __arm__
#define BARQ_ARCH_ARM
#endif
...
#if defined(BARQ_PTR_64) && defined(BARQ_X86_OR_X64) && !BARQ_WATCHOS
#define BARQ_COMPILER_SSE // Compiler supports SSE 4.2 through __builtin_ accessors or back-end assembler
#define BARQ_COMPILER_AVX
#endif
...
{
    BARQ_ASSERT_DEBUG(!util::int_cast_has_overflow<size_t>(v));
    return size_t(v);
}
...
// Use barq::safe_equal() instead of std::equal() if one of the parameters can be a null pointer.
...
// Use barq::safe_copy_n() instead of std::copy_n() if one of the parameters can be a null pointer. See the
