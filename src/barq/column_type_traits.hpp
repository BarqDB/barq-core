...
#ifndef BARQ_COLUMN_TYPE_TRAITS_HPP
#define BARQ_COLUMN_TYPE_TRAITS_HPP
...
struct ObjectTypeTraits {
    constexpr static bool self_contained_null =
        barq::is_any_v<T, StringData, BinaryData, Decimal128, Timestamp, Mixed>;
};
...
#endif // BARQ_COLUMN_TYPE_TRAITS_HPP
