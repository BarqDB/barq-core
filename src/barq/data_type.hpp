...
#ifndef BARQ_DATA_TYPE_HPP
#define BARQ_DATA_TYPE_HPP
...
typedef barq::StringData String;
typedef barq::BinaryData Binary;
typedef barq::Decimal128 Decimal;
