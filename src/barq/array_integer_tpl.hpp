...
#ifndef BARQ_ARRAY_INTEGER_TPL_HPP
#define BARQ_ARRAY_INTEGER_TPL_HPP
...
size_t ArrayIntNull::find_first(value_type value, size_t start, size_t end) const
{
    ...
    if (end - start == 1) {
        ...
        return c(opt_int, value, !opt_int, !value) ? start : barq::not_found;
    }
...
#endif /* BARQ_ARRAY_INTEGER_TPL_HPP */
