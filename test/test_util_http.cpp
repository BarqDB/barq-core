...
TEST(HTTP_RequestResponse)
{
    ...
    CHECK_EQUAL(received_request->headers["X-Barq-Foo"], "Bar");
    ...
    CHECK_EQUAL(received_response->headers["X-Barq-Foo"], "Bar");
