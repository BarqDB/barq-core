...
TEST(BasicSystemErrors_Category)
{
    ...
    CHECK_EQUAL(err.category().name(), "barq.basic_system");
}
...
#if !BARQ_HAVE_CLANG_FEATURE(undefined_behavior_sanitizer)
...
#endif // !BARQ_HAVE_CLANG_FEATURE(undefined_behavior_sanitizer)
}
