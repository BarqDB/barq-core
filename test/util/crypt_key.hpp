...
#ifndef BARQ_TEST_UTIL_CRYPT_KEY_HPP
#define BARQ_TEST_UTIL_CRYPT_KEY_HPP
...
/// (BARQ_ENABLE_ENCRYPTION), and either \a always is true or global mode
...
#endif // BARQ_TEST_UTIL_CRYPT_KEY_HPP
