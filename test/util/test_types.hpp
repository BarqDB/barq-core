...
#ifndef BARQ_TEST_UTIL_TEST_TYPES_HPP
#define BARQ_TEST_UTIL_TEST_TYPES_HPP
...
#define TEST_TYPES_IF(name, enabled, ...)                                                                            \
    TEST_TYPES_EX(name, barq::test_util::unit_test::get_default_test_list(), enabled, true, __VA_ARGS__)
...
#define NONCONCURRENT_TEST_TYPES_IF(name, enabled, ...)                                                              \
    TEST_TYPES_EX(name, barq::test_util::unit_test::get_default_test_list(), enabled, false, __VA_ARGS__)
...
#define TEST_TYPES_EX(name, list, enabled, allow_concur, ...)                                                        \
    ...
    barq::test_util::unit_test::RegisterTypeTests<Barq_UnitTest__##name, __VA_ARGS__> barq_unit_test_reg__##name( \
...
#endif // BARQ_TEST_UTIL_TEST_TYPES_HPP
