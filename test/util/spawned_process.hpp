...
#ifndef BARQ_TEST_UTIL_SPAWNED_PROCESS_HPP
#define BARQ_TEST_UTIL_SPAWNED_PROCESS_HPP
...
// a child process via the BARQ_CHILD_IDENT environment variable, then no process is actually started here.
...
#endif // BARQ_TEST_UTIL_SPAWNED_PROCESS_HPP
