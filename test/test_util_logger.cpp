...
TEST(Util_Logger_LevelThreshold)
{
    ...
    auto prefix_logger =
        PrefixLogger(util::LogCategory::barq, "test", threadsafe_logger); // created using Logger shared_ptr
    auto prefix_logger2 = PrefixLogger("test2", prefix_logger);            // created using PrefixLogger

    auto default_log_level = util::LogCategory::barq.get_default_level_threshold();
    ...
    base_logger->set_level_threshold("Barq.Storage", Logger::Level::debug);
...
TEST(Util_Logger_LocalThresholdLogger)
{
    ...
    auto orig_level = LogCategory::barq.get_default_level_threshold();
    ...
    auto prefix_logger = PrefixLogger(util::LogCategory::barq, "test", lt_logger);
    auto prefix_logger2 = PrefixLogger(util::LogCategory::barq, "test2", lt_logger2);
    ...
    CHECK_EQUAL(orig_level, LogCategory::barq.get_default_level_threshold());
}
...
TEST(Util_Logger_Categories)
{
    ...
    CHECK(logger().empty());
    logger.set_level_threshold("Barq.Storage.Query", util::Logger::Level::debug);
    logger.log(util::LogCategory::object, util::Logger::Level::debug, "Object");
    logger.log(util::LogCategory::query, util::Logger::Level::debug, "Query");
    CHECK_EQUAL(logger(), "Query");
    logger.set_level_threshold("Barq.Storage.Object", util::Logger::Level::debug);
    logger.log(util::LogCategory::object, util::Logger::Level::debug, "Object");
    logger.log(util::LogCategory::query, util::Logger::Level::debug, "Query");
...
TEST(Util_Logger_Prefix)
{
    ...
    std::ostringstream out_2;
    {
        ...
        util::PrefixLogger logger1(util::LogCategory::barq, "Prefix: ", root_logger);
