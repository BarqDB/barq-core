...
#ifndef BARQ_TEST_UTILS_HPP
#define BARQ_TEST_UTILS_HPP
...
class Barq;
/// Open a Barq at a given path, creating its files.
void create_dummy_barq(std::string path, std::shared_ptr<Barq>* out = nullptr);
...
#define REQUIRE_BARQ_EXISTS(macro_path)                                                                             \
    do {                                                                                                             \
...
#define REQUIRE_EXCEPTION(expr, c, msg)                                                                              \
    REQUIRE_THROWS_MATCHES(expr, barq::Exception, _impl::make_exception_matcher(barq::ErrorCodes::c, msg))
...
#define ENCODE_FAKE_JWT(in) barq::encode_fake_jwt(in)

#endif // BARQ_TEST_UTILS_HPP
