...
#ifndef BARQ_TEST_COLLECTION_FIXTURES_HPP
#define BARQ_TEST_COLLECTION_FIXTURES_HPP
...
namespace barq::collection_fixtures {
...
struct UUID : Base<PropertyType::UUID, barq::UUID> {
    ...
    {
        return {barq::UUID("3b241101-e2bb-4255-8caf-4136c566a962"),
                barq::UUID("3b241101-a2b3-4255-8caf-4136c566a999")};
    }
};
...
struct ListOfObjects : public LinkedCollectionBase {
    ...
    List get_collection(SharedBarq r, Obj obj)
    {
...
struct SetOfObjects : public LinkedCollectionBase {
    ...
    object_store::Set get_collection(SharedBarq r, Obj obj)
    {
...
struct DictionaryOfObjects : public LinkedCollectionBase {
    ...
    object_store::Dictionary get_collection(SharedBarq r, Obj obj)
    {
...
#endif // BARQ_TEST_COLLECTION_FIXTURES_HPP
