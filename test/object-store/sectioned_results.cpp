...
#include <barq/util/any.hpp>

using namespace barq;
using namespace barq::util;

namespace barq::sectioned_results_fixtures {
...
struct MixedVal : Base<PropertyType::Mixed, barq::Mixed> {
    static std::vector<barq::Mixed> values()
    {
        return {Mixed{barq::UUID()},      Mixed{int64_t(1)},
    ...
    static std::vector<barq::Mixed> expected_sorted()
    {
...
struct UUID : Base<PropertyType::UUID, barq::UUID> {
    static std::vector<barq::UUID> values()
    {
        return {
            barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
            barq::UUID("1b241101-a2b3-4255-8caf-4136c566a999"), barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
            barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), barq::UUID("1b241101-a2b3-4255-8caf-4136c566a999"),
            barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), barq::UUID("1b241101-a2b3-4255-8caf-4136c566a999"),
            barq::UUID("1b241101-a2b3-4255-8caf-4136c566a999"), barq::UUID("1b241101-a2b3-4255-8caf-4136c566a999"),
        };
    }

    static std::vector<barq::UUID> expected_sorted()
    {
        return {
            barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
            barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
    ...
    static std::vector<Mixed> expected_keys()
    {
        return {barq::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
                barq::UUID("1b241101-a2b3-4255-8caf-4136c566a999")};
    }
...
struct UnboxedOptional : BaseT {
    ...
    static auto values() -> decltype(BaseT::values())
    {
        ...
        if constexpr (std::is_same_v<BaseT, sectioned_results_fixtures::Decimal>) {
            ...
            ret.push_back(Decimal128(barq::null()));
        }
        else {
    ...
    static auto expected_sorted() -> decltype(BaseT::values())
    {
        ...
        if constexpr (std::is_same_v<BaseT, sectioned_results_fixtures::Decimal>) {
            // The default Decimal128 ctr is 0, but we want a null value
            ret.insert(ret.begin(), Decimal128(barq::null()));
        }
        else {
...
TEST_CASE("sectioned results", "[sectioned results]") {
    ...
    auto sectioned_results = sorted.sectioned_results([&algo_run_count](Mixed value, const SharedBarq& barq) {
        algo_run_count++;
        auto obj = Object(barq, value.get_link());
    ...
    SECTION("reset section callback") {
        sectioned_results.reset_section_callback([&](Mixed value, SharedBarq barq) {
            algo_run_count++;
            auto obj = Object(barq, value.get_link());
            auto v = obj.get_column_value<StringData>("name_col");
            return v.prefix(2);
    ...
    SECTION("correctly asserts key") {
        ...
        auto sr = sorted.sectioned_results([](Mixed value, SharedBarq) {
        ...
        sr = sorted.sectioned_results([&](Mixed value, SharedBarq barq) {
            auto obj = Object(barq, value.get_link());
    ...
    SECTION("notifications ascending / descending") {
        ...
        sectioned_results = sorted.sectioned_results([&algo_run_count](Mixed value, SharedBarq barq) {
            algo_run_count++;
            auto obj = Object(barq, value.get_link());
            auto v = obj.get_column_value<StringData>("name_col");
            return v.prefix(1);
    ...
    SECTION("notifications ascending / descending primitive") {
        ...
        r->commit_transaction();
        List lst(r, o1, array_string_col);
        sectioned_results = lst.sort({{"self", true}}).sectioned_results([&algo_run_count](Mixed value, SharedBarq) {
            algo_run_count++;
        ...
        // Descending
        sectioned_results =
            lst.sort({{"self", false}}).sectioned_results([&algo_run_count](Mixed value, SharedBarq) {
                algo_run_count++;
                auto v = value.get_string();
                return v.prefix(1);
            });
    ...
    SECTION("frozen") {
        auto frozen_barq = r->freeze();
        REQUIRE(!sectioned_results.is_frozen());
        auto sr_frozen = sectioned_results.freeze(frozen_barq);
        ...
        for (size_t i = 0; i < sr_frozen.size(); i++) {
            ...
            for (size_t y = 0; y < section.size(); y++) {
                auto val = Object(frozen_barq, section[y].get_link()).get_column_value<StringData>("name_col");
                REQUIRE(expected[count] == val);
                count++;
            }
        }
...
TEST_CASE("sectioned results link notification bug", "[sectioned results]") {
    ...
    auto sectioned_results = sorted.sectioned_results([](Mixed value, SharedBarq barq) {
        auto obj = Object(barq, value.get_link());
...
namespace cf = barq::sectioned_results_fixtures;
                   ...
                   cf::UnboxedOptional<cf::Decimal>)
{
    ...
    SECTION("primitives section correctly with sort ascending") {
        ...
        auto sectioned_results = sorted.sectioned_results([&algo_run_count](Mixed value, SharedBarq) -> Mixed {
            algo_run_count++;
    ...
    SECTION("frozen primitive") {
        ...
        auto frozen_barq = r->freeze();
        auto frozen_sr = sectioned_results.freeze(frozen_barq);
    ...
    SECTION("frozen results primitive") {
        auto frozen_barq = r->freeze();
        auto sorted = results.sort({{"self", true}}).freeze(frozen_barq);
        auto sectioned_results = sorted.sectioned_results([&algo_run_count](Mixed value, SharedBarq) -> Mixed {
            algo_run_count++;
            return TestType::comparison_value(value);
        });
