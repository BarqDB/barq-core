...
static std::vector<std::pair<std::string_view, barq::util::Logger::Level>> default_log_levels = {
    {"Barq", barq::util::Logger::Level::TEST_LOGGING_LEVEL},
#ifdef TEST_LOGGING_LEVEL_STORAGE
    {"Barq.Storage", barq::util::Logger::Level::TEST_LOGGING_LEVEL_STORAGE},
#endif
#ifdef TEST_LOGGING_LEVEL_TRANSACTION
    {"Barq.Storage.Transaction", barq::util::Logger::Level::TEST_LOGGING_LEVEL_TRANSACTION},
#endif
#ifdef TEST_LOGGING_LEVEL_QUERY
    {"Barq.Storage.Query", barq::util::Logger::Level::TEST_LOGGING_LEVEL_QUERY},
#endif
#ifdef TEST_LOGGING_LEVEL_OBJECT
    {"Barq.Storage.Object", barq::util::Logger::Level::TEST_LOGGING_LEVEL_OBJECT},
#endif
#ifdef TEST_LOGGING_LEVEL_NOTIFICATION
    {"Barq.Storage.Notification", barq::util::Logger::Level::TEST_LOGGING_LEVEL_NOTIFICATION},
#endif
#ifdef TEST_LOGGING_LEVEL_SYNC
    {"Barq.Sync", barq::util::Logger::Level::TEST_LOGGING_LEVEL_SYNC},
#endif
#ifdef TEST_LOGGING_LEVEL_CLIENT
    {"Barq.Sync.Client", barq::util::Logger::Level::TEST_LOGGING_LEVEL_CLIENT},
#endif
#ifdef TEST_LOGGING_LEVEL_SESSION
    {"Barq.Sync.Client.Session", barq::util::Logger::Level::TEST_LOGGING_LEVEL_SESSION},
#endif
#ifdef TEST_LOGGING_LEVEL_CHANGESET
    {"Barq.Sync.Client.Changeset", barq::util::Logger::Level::TEST_LOGGING_LEVEL_CHANGESET},
#endif
#ifdef TEST_LOGGING_LEVEL_NETWORK
    {"Barq.Sync.Client.Network", barq::util::Logger::Level::TEST_LOGGING_LEVEL_NETWORK},
#endif
#ifdef TEST_LOGGING_LEVEL_RESET
    {"Barq.Sync.Client.Reset", barq::util::Logger::Level::TEST_LOGGING_LEVEL_RESET},
#endif
#ifdef TEST_LOGGING_LEVEL_SERVER
    {"Barq.Sync.Server", barq::util::Logger::Level::TEST_LOGGING_LEVEL_SERVER},
#endif
#ifdef TEST_LOGGING_LEVEL_APP
    {"Barq.App", barq::util::Logger::Level::TEST_LOGGING_LEVEL_APP},
#endif
};
...
static void set_default_level_thresholds()
{
    for (auto [cat, level] : default_log_levels) {
        barq::util::LogCategory::get_category(cat).set_default_level_threshold(level);
    }
}
...
int run_object_store_tests(int argc, const char** argv)
{
    ...
    barq::test_util::initialize_test_path(1, argv);
    ...
    if (const char* str = getenv("UNITTEST_EVERGREEN_TEST_RESULTS"); str && strlen(str) != 0) {
        ...
        if (std::filesystem::exists(str)) {
            std::string results_copy = barq::util::format("%1.bak", str);
    ...
    if (const char* env = getenv("UNITTEST_ENCRYPT_ALL")) {
        ...
        if (str == "1" || str == "on" || str == "yes") {
            barq::test_util::enable_always_encrypt();
        }
    }
    ...
    barq::util::Scheduler::set_default_factory([]() -> std::shared_ptr<barq::util::Scheduler> {
        // The libuv scheduler can only be constructed from the main thread
        BARQ_ASSERT_RELEASE(std::this_thread::get_id() == s_main_thread_id);
        return std::make_shared<barq::util::UvMainLoopScheduler>();
    });
#endif
