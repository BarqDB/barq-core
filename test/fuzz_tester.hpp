...
#ifndef BARQ_TEST_FUZZ_TESTER_HPP
#define BARQ_TEST_FUZZ_TESTER_HPP
...
private:
    ...
    void insert_column(Peer& client)
    {
        ...
        if (m_trace) {
            ...
            if (type == type_Int) {
                ...
                BARQ_TERMINATE("Missing trace support for column type.");
            }
    ...
    {
        BARQ_ASSERT(count_classes(client) > 1);
    ...
    {
        BARQ_ASSERT(!m_unstructured_columns.empty());
            ...
            if (rest_weight < modify_weight) {
                ...
                if (group_level) {
                    ...
                    if (table_level) {
                        ...
                        BARQ_ASSERT(n > 0); // No columns implies no rows
                        ...
                        if (is_array) {
                            ...
                            if (type == type_Int) {
                                ...
                                BARQ_TERMINATE("Unsupported list type.");
                            }
                            size_t num_elements = client.selected_array->size();
...
#endif // BARQ_TEST_FUZZ_TESTER_HPP
