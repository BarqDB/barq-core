...
if(CMAKE_BUILD_TYPE STREQUAL "Coverage")
  ...
  function(create_coverage_target targetname testrunner)
    ...
    add_custom_target(${targetname}-cobertura
      COMMAND ${testrunner}
      COMMAND ${GCOVR_PATH} -x -o coverage.xml -f 'src/.*' -f "${CMAKE_SOURCE_DIR}/src.*" --exclude-directories "${CMAKE_BINARY_DIR}/tests" --exclude-directories="${CMAKE_SOURCE_DIR}/\.tmp" --exclude ".*barq\-core.*" --exclude ".*barq\-sync.*"
